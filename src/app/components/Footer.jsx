  ...
  return (
    <footer id="footer" className="mt-12 pb-8 flex flex-col justify-center items-center bg-[#0f0510]">
      ...
      <div className="policies flex items-center gap-5 flex-wrap justify-center font-light text-sm">
         <Link href="#" className="hover:opacity-70">Contatos</Link>
         <Link href="#" className="hover:opacity-70">Política de Privacidade</Link>
         <Link href="#" className="hover:opacity-70">termos & serviços</Link>
         <span>2025©WWW</span>
      </div>
    </footer>
  )
