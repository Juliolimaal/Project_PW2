...
>>>>>>>> 8800a2d410678f7534a118ef4a5a1fe15c942736:src/pages/wine_rose.js
  ...
  <nav class="flex justify-around items-center bg-white h-[15vh] font-lexend">
    <a href="#"
      class="text-[#DF587D] no-underline transition duration-300 logo text-2xl uppercase tracking-[4px] hover:scale-110" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="linear" data-aos-delay="500">
...
>>>>>>>> 8800a2d410678f7534a118ef4a5a1fe15c942736:src/pages/wine_rose.js
  ...
  <ul id="nav-list"
    ...
    <li class="mr-12 opacity-0 transition-opacity duration-300"><a href="#" class="text-[#DF587D]">Home</a></li>
    <li class="mr-12 opacity-0 transition-opacity duration-300"><a href="#" class="text-[#DF587D]">Sobre</a></li>
  </ul>
  ...
  <main>
    <section class="first">
      <div class="flex justify-around px-0 lg:px-24 md:px-5">
        <div
          class="w-[130px] h-[130px] md:w-[180px] md:h-[180px] flex flex-col justify-center items-center bg-[#DF587D] text-white font-['Lexend_Exa'] text-lg rounded-full mb-12 transition duration-500 hover:-translate-y-2.5" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="linear">
          <span class="material-symbols-outlined text-5xl">nutrition</span>
          <p>fresco</p>
        </div>
        <div
          class="w-[130px] h-[130px] md:w-[180px] md:h-[180px] flex flex-col justify-center items-center bg-[#DF587D] text-white font-['Lexend_Exa'] text-lg rounded-full mb-12 transition duration-500 hover:-translate-y-2.5" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="linear" data-aos-delay="100">
          <span class="material-symbols-outlined text-5xl">psychiatry</span>
          <p>suave</p>
        </div>
        <div
          class="w-[130px] h-[130px] md:w-[180px] md:h-[180px] flex flex-col justify-center items-center bg-[#DF587D] text-white font-['Lexend_Exa'] text-lg rounded-full mb-12 transition duration-500 hover:-translate-y-2.5" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="linear" data-aos-delay="200">
      ...
      <div class="mx-8 flex flex-col lg:flex-row justify-center items-center gap-16">
        <div
          ...
          <p class="font-light mb-5 text-justify text-sm md:text-base">
            ...
            Na boca, é leve e equilibrado, com doçura suave e um frescor que prolonga o prazer a cada gole. Ideal para servir bem gelado, em momentos leves e celebrações descontraídas.
          </p>
          <div class="flex gap-5 md:gap-10">
            <div
              ...
              data-name="Port Da Luz Rosé" 
              data-price="999.99">
                <span class="material-symbols-outlined">shopping_bag</span>
                <a>comprar</a>
            </div>
            <div class="group flex gap-2.5 text-[#DF587D] px-8 py-2.5 transition-all duration-500">
    ...
    <div class="w-full max-w-6xl mx-auto md:mt-0 mt-12 mb-24 px-4 flex items-center justify-center" data-aos="fade-down" data-aos-duration="1500" data-aos-easing="linear" data-aos-delay="300">
      <div class="w-full lg:w-910px md:w-700px sm:w-450px mx-auto p-12 bg-white rounded-3xl shadow-lg">
        ...
        <form action="#" method="POST">
          ...
          <div class="mb-20">
            <label for="vinho_favorito" class="font-lexend sm:text-sm">Algum vinho rosé favorito atual?</label>
            <div>
          ...
          <div>
            <button type="submit" 
                  class="font-lexend bg-[#DF587D] hover:bg-[#888b2c] text-white py-2 px-5 border-none cursor-pointer transition duration-500">
              Enviar
            </button>
          </div>
        </form>
...
<div id="cart-panel"
  ...
  <h2 class="text-2xl font-lexend mb-4 text-[#DF587D]">Carrinho</h2>
  ...
  <div class="border-t border-gray-300 mt-4 pt-4">
    ...
    <button id="clear-cart"
            class="mt-4 bg-[#DF587D] text-white px-4 py-2 rounded hover:bg-[#B23D56] transition duration-300">
      Esvaziar carrinho
    </button>
  </div>
</div>
